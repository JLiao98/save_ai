          ...
          children: [
            ...
            SafeArea(
              child: animatedText(
                text: [
                  "Hello there!",
                  "What are your gender, birth date, birth time, and birth place?",
                ],
                onFinished: () {
                  setState(() {
                    isFinished = true;
                ...
                : Column(children: [
                    ...
                    GroupButton(
                      ...
                      buttons: List.generate(
                          Goal.length, (index) => Goal[index]["goal_name"]),
                      selectedTextStyle: TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 13,
                        color: Colors.white,
                    ...
                    Container(
                      ...
                      child: SelectState(
                        onCountryChanged: (value) {
                          setState(() {
                            countryValue = value;
                            birth_country = countryValue.substring(8);
                          });
                        },
                        onStateChanged: (value) {
                          setState(() {
                            stateValue = value;
                            birth_state = stateValue;
                          });
                        },
                        onCityChanged: (value) {
                          setState(() {
