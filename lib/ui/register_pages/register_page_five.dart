...
class RegisterPageState extends State<RegisterPageFive>
  ...
  Widget animatedTextTap({List<String> text, onTap}) {
    return Container(
        width: MediaQuery.of(context).size.width * 0.75,
        child: TypewriterAnimatedTextKit(
          totalRepeatCount: 1,
  ...
  _launchURL() async {
    const url = 'https://www.5lovelanguages.com/';
  ...
  Widget buildButtons() {
    ...
    return !isFinished
        ...
        : Column(children: [
            ...
            animatedTextTap(
                text: ["Don't know what's love language? Click Here!"],
                onTap: () async {
                  await _launchURL();
                })
            // SizedBox(height: MediaQuery.of(context).size.height * 0.01),
        ...
        child: Column(
          children: [
            ...
            SafeArea(
              child: animatedText(
                text: [
                  "What are your interests and love languages?",
                ],
                onFinished: () {
                  setState(() {
                    isFinished = true;
